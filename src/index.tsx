...
import { DdaiChatBoxProps, DdaiChatBox } from "./ddai-chat-box";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/ddai-chat-box.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <ddai-chat-box message="world!"></ddai-chat-box>
   */
  return class DdaiChatBoxBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): DdaiChatBoxProps {
      const attrs = this.parseAttributes<DdaiChatBoxProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<DdaiChatBox {...this.props} />);
    }
